...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_btn = Button(image=self.green_img, highlightthickness=0, command=self.is_true)
        self.true_btn.grid(row=2, column=0)
        self.red_img = PhotoImage(file="images/false.png")
        self.false_btn = Button(image=self.red_img, highlightthickness=0, command=self.is_false)
